    ...
    <div style={{ background: '#FFF8F0', minHeight: '100vh', fontFamily: 'var(--font-main)' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <Image src="/logo_v2.png" alt="CivicLens Logo" width={38} height={38} style={{ border: '2px solid #000', borderRadius: '4px', boxShadow: scrolled ? '2px 2px 0 #000' : '2px 2px 0 rgba(0,0,0,0.5)' }} />
          <span style={{
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <Image src="/logo_v2.png" alt="CivicLens Logo" width={32} height={32} style={{ border: '2px solid #fff', borderRadius: '4px' }} />
          <div>
