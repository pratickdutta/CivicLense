...
export default function LandingPage() {
  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh', fontFamily: 'var(--font-main)' }}>
      ...
      {/* ── STATS STRIP ── */}
      <section style={{ background: 'var(--primary)', padding: 'clamp(24px,4vw,40px)', borderTop: '1.5px solid var(--border)', borderBottom: '1.5px solid var(--border)' }}>
        <div className="hero-grid-4" style={{ maxWidth: '900px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '20px', textAlign: 'center' }}>
          {stats.map(s => (
            <div key={s.label}>
      ...
      {/* ── FEATURES ── */}
      <section style={{ padding: 'clamp(32px,5vw,60px) clamp(16px,4vw,40px)', background: 'var(--surface)', borderTop: '1.5px solid var(--border-subtle)', borderBottom: '1.5px solid var(--border-subtle)' }}>
      ...
      {/* ── CTA ── */}
      <section style={{ padding: 'clamp(40px,6vw,80px) clamp(16px,4vw,40px)', textAlign: 'center' }}>
